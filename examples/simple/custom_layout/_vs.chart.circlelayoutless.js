...
$.fn._vs.chart.CircleLayoutLess = function(_this,fn,options) {
  ...
  this.setupPieChartPhysics = function(_this){
    ...
    var radius = _this.settings.chart.radius
      ...
      var axis   = pivot(csX,csY,1, _this.settings.chart.wallColor);
  ...
  function pivot (centerSceneX,centerSceneY,radius,color){
    ...
    axis.m_userData     = {type:"Pivot",familyID:null,fillColor:color,r:radius}
    return  axis;
  }
